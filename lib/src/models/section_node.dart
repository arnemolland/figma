...
part 'section_node.g.dart';

@JsonSerializable(explicitToJson: true)
@CopyWith()
@immutable
class SectionNode extends SubCanvasNode
    with
        IsLayerTrait,
        HasGeometryTrait,
        HasChildrenTrait,
  ...
  factory SectionNode.fromJson(Map<String, Object?> json) =>
  ...
  @override
  Map<String, Object?> toJson() => _$SectionNodeToJson(this);
}
