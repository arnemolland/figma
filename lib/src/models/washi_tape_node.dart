...
@CopyWith()
@immutable
class WashiTapeNode extends SubCanvasNode with DefaultShapeTraits {
  const WashiTapeNode({
    required this.id,
    required this.name,
    this.visible = true,
  ...
  factory WashiTapeNode.fromJson(Map<String, Object?> json) =>
      _$WashiTapeNodeFromJson(json);
  ...
  @override
  NodeType get type => NodeType.washiTape;

  @override
  List<Object?> get props => <Object?>[...super.props];

  @override
  Map<String, Object?> toJson() => _$WashiTapeNodeToJson(this);
}
