...
abstract class _$GroupNodeCWProxy {
  GroupNode id(String id);

  GroupNode name(String name);

  GroupNode visible(bool visible);

  GroupNode locked(bool locked);

  GroupNode scrollBehavior(ScrollBehavior scrollBehavior);

  GroupNode rotation(num rotation);

  GroupNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  GroupNode pluginData(Object? pluginData);

  GroupNode sharedPluginData(Object? sharedPluginData);

  GroupNode boundVariables(LayerTraitVariables boundVariables);

  GroupNode explicitVariableModes(Map<String, String> explicitVariableModes);

  GroupNode blendMode(BlendMode blendMode);

  GroupNode opacity(num opacity);

  GroupNode children(List<SubCanvasNode> children);

  GroupNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  GroupNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  GroupNode preserveRatio(bool preserveRatio);

  GroupNode constraints(LayoutConstraint? constraints);

  GroupNode relativeTransform(Transform? relativeTransform);

  GroupNode size(Vector? size);

  GroupNode layoutAlign(LayoutAlign? layoutAlign);

  GroupNode layoutGrow(LayoutGrow layoutGrow);

  GroupNode layoutPositioning(LayoutPositioning layoutPositioning);

  GroupNode minWidth(num minWidth);

  GroupNode maxWidth(num maxWidth);

  GroupNode minHeight(num minHeight);

  GroupNode maxHeight(num maxHeight);

  GroupNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  GroupNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  GroupNode gridRowCount(num? gridRowCount);

  GroupNode gridColumnCount(num? gridColumnCount);

  GroupNode gridRowGap(num gridRowGap);

  GroupNode gridColumnGap(num gridColumnGap);

  GroupNode gridColumnsSizing(String? gridColumnsSizing);

  GroupNode gridRowsSizing(String? gridRowsSizing);

  GroupNode gridChildHorizontalAlign(GridChildAlign? gridChildHorizontalAlign);

  GroupNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  GroupNode gridRowSpan(num gridRowSpan);

  GroupNode gridColumnSpan(num gridColumnSpan);

  GroupNode gridRowAnchorIndex(num gridRowAnchorIndex);

  GroupNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  GroupNode clipsContent(bool clipsContent);

  GroupNode layoutGrids(List<LayoutGrid> layoutGrids);

  GroupNode overflowDirection(OverflowDirection overflowDirection);

  GroupNode layoutMode(LayoutMode layoutMode);

  GroupNode primaryAxisSizingMode(PrimaryAxisSizingMode primaryAxisSizingMode);

  GroupNode counterAxisSizingMode(CounterAxisSizingMode counterAxisSizingMode);

  GroupNode primaryAxisAlignItems(PrimaryAxisAlignItems primaryAxisAlignItems);

  GroupNode counterAxisAlignItems(CounterAxisAlignItems counterAxisAlignItems);

  GroupNode paddingLeft(num paddingLeft);

  GroupNode paddingRight(num paddingRight);

  GroupNode paddingTop(num paddingTop);

  GroupNode paddingBottom(num paddingBottom);

  GroupNode itemSpacing(num itemSpacing);

  GroupNode itemReverseZIndex(bool itemReverseZIndex);

  GroupNode strokesIncludedInLayout(bool strokesIncludedInLayout);

  GroupNode layoutWrap(LayoutWrap? layoutWrap);

  GroupNode counterAxisSpacing(num? counterAxisSpacing);

  GroupNode counterAxisAlignContent(
    CounterAxisAlignContent counterAxisAlignContent,
  );

  GroupNode cornerRadius(num cornerRadius);

  GroupNode cornerSmoothing(num cornerSmoothing);

  GroupNode rectangleCornerRadii(List<num> rectangleCornerRadii);

  GroupNode fills(List<Paint> fills);

  GroupNode styles(Map<String, String> styles);

  GroupNode strokes(List<Paint> strokes);

  GroupNode strokeWeight(num strokeWeight);

  GroupNode strokeAlign(StrokeAlign? strokeAlign);

  GroupNode strokeJoin(StrokeJoin strokeJoin);

  GroupNode strokeDashes(List<num> strokeDashes);

  GroupNode fillOverrideTable(Map<String, PaintOverride?> fillOverrideTable);

  GroupNode fillGeometry(List<Path> fillGeometry);

  GroupNode strokeGeometry(List<Path> strokeGeometry);

  GroupNode strokeCap(StrokeCap strokeCap);

  GroupNode strokeMiterAngle(num strokeMiterAngle);

  GroupNode exportSettings(List<ExportSetting> exportSettings);

  GroupNode effects(List<Effect> effects);

  GroupNode isMask(bool isMask);

  GroupNode maskType(MaskType? maskType);

  GroupNode transitionNodeId(String? transitionNodeId);

  GroupNode transitionDuration(num? transitionDuration);

  GroupNode transitionEasing(EasingType? transitionEasing);

  GroupNode interactions(List<Interaction> interactions);

  GroupNode individualStrokeWeights(StrokeWeights? individualStrokeWeights);

  GroupNode devStatus(DevStatus? devStatus);
...
/// Use as `instanceOfGroupNode.copyWith(...)` or call `instanceOfGroupNode.copyWith.fieldName(value)` for a single field.
class _$GroupNodeCWProxyImpl implements _$GroupNodeCWProxy {
  const _$GroupNodeCWProxyImpl(this._value);

  final GroupNode _value;

  @override
  GroupNode id(String id) => call(id: id);

  @override
  GroupNode name(String name) => call(name: name);

  @override
  GroupNode visible(bool visible) => call(visible: visible);

  @override
  GroupNode locked(bool locked) => call(locked: locked);
  ...
  @override
  GroupNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  GroupNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  GroupNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  GroupNode opacity(num opacity) => call(opacity: opacity);

  @override
  GroupNode children(List<SubCanvasNode> children) => call(children: children);
  ...
  @override
  GroupNode size(Vector? size) => call(size: size);
  ...
  @override
  GroupNode layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  GroupNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  GroupNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  GroupNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  GroupNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  GroupNode gridRowCount(num? gridRowCount) => call(gridRowCount: gridRowCount);
  ...
  @override
  GroupNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  GroupNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  ...
  @override
  GroupNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  GroupNode clipsContent(bool clipsContent) => call(clipsContent: clipsContent);
  ...
  @override
  GroupNode layoutMode(LayoutMode layoutMode) => call(layoutMode: layoutMode);

  @override
  GroupNode primaryAxisSizingMode(
    PrimaryAxisSizingMode primaryAxisSizingMode,
  ) => call(primaryAxisSizingMode: primaryAxisSizingMode);

  @override
  GroupNode counterAxisSizingMode(
    CounterAxisSizingMode counterAxisSizingMode,
  ) => call(counterAxisSizingMode: counterAxisSizingMode);

  @override
  GroupNode primaryAxisAlignItems(
    PrimaryAxisAlignItems primaryAxisAlignItems,
  ) => call(primaryAxisAlignItems: primaryAxisAlignItems);

  @override
  GroupNode counterAxisAlignItems(
    CounterAxisAlignItems counterAxisAlignItems,
  ) => call(counterAxisAlignItems: counterAxisAlignItems);

  @override
  GroupNode paddingLeft(num paddingLeft) => call(paddingLeft: paddingLeft);

  @override
  GroupNode paddingRight(num paddingRight) => call(paddingRight: paddingRight);

  @override
  GroupNode paddingTop(num paddingTop) => call(paddingTop: paddingTop);
  ...
  @override
  GroupNode itemSpacing(num itemSpacing) => call(itemSpacing: itemSpacing);
  ...
  @override
  GroupNode layoutWrap(LayoutWrap? layoutWrap) => call(layoutWrap: layoutWrap);
  ...
  @override
  GroupNode cornerRadius(num cornerRadius) => call(cornerRadius: cornerRadius);
  ...
  @override
  GroupNode fills(List<Paint> fills) => call(fills: fills);

  @override
  GroupNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  GroupNode strokes(List<Paint> strokes) => call(strokes: strokes);

  @override
  GroupNode strokeWeight(num strokeWeight) => call(strokeWeight: strokeWeight);
  ...
  @override
  GroupNode strokeJoin(StrokeJoin strokeJoin) => call(strokeJoin: strokeJoin);
  ...
  @override
  GroupNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  GroupNode effects(List<Effect> effects) => call(effects: effects);

  @override
  GroupNode isMask(bool isMask) => call(isMask: isMask);

  @override
  GroupNode maskType(MaskType? maskType) => call(maskType: maskType);
...
extension $GroupNodeCopyWith on GroupNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfGroupNode.copyWith(...)` or `instanceOfGroupNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$GroupNodeCWProxy get copyWith => _$GroupNodeCWProxyImpl(this);
}
