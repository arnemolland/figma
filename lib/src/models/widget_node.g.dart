...
abstract class _$WidgetNodeCWProxy {
  WidgetNode id(String id);

  WidgetNode name(String name);

  WidgetNode visible(bool visible);

  WidgetNode locked(bool locked);

  WidgetNode scrollBehavior(ScrollBehavior scrollBehavior);

  WidgetNode rotation(num rotation);

  WidgetNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  WidgetNode pluginData(Object? pluginData);

  WidgetNode sharedPluginData(Object? sharedPluginData);

  WidgetNode boundVariables(LayerTraitVariables boundVariables);

  WidgetNode explicitVariableModes(Map<String, String> explicitVariableModes);

  WidgetNode exportSettings(List<ExportSetting> exportSettings);

  WidgetNode children(List<SubCanvasNode> children);
...
/// Use as `instanceOfWidgetNode.copyWith(...)` or call `instanceOfWidgetNode.copyWith.fieldName(value)` for a single field.
class _$WidgetNodeCWProxyImpl implements _$WidgetNodeCWProxy {
  const _$WidgetNodeCWProxyImpl(this._value);

  final WidgetNode _value;

  @override
  WidgetNode id(String id) => call(id: id);

  @override
  WidgetNode name(String name) => call(name: name);

  @override
  WidgetNode visible(bool visible) => call(visible: visible);

  @override
  WidgetNode locked(bool locked) => call(locked: locked);
  ...
  @override
  WidgetNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  WidgetNode pluginData(Object? pluginData) => call(pluginData: pluginData);
...
extension $WidgetNodeCopyWith on WidgetNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfWidgetNode.copyWith(...)` or `instanceOfWidgetNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$WidgetNodeCWProxy get copyWith => _$WidgetNodeCWProxyImpl(this);
}
