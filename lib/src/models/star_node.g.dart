...
part of 'star_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$StarNodeCWProxy {
  StarNode id(String id);

  StarNode name(String name);

  StarNode visible(bool visible);

  StarNode locked(bool locked);

  StarNode scrollBehavior(ScrollBehavior scrollBehavior);

  StarNode rotation(num rotation);

  StarNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  StarNode pluginData(Object? pluginData);

  StarNode sharedPluginData(Object? sharedPluginData);

  StarNode boundVariables(LayerTraitVariables boundVariables);

  StarNode explicitVariableModes(Map<String, String> explicitVariableModes);

  StarNode blendMode(BlendMode blendMode);

  StarNode opacity(num opacity);

  StarNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  StarNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  StarNode preserveRatio(bool preserveRatio);

  StarNode constraints(LayoutConstraint? constraints);

  StarNode relativeTransform(Transform? relativeTransform);

  StarNode size(Vector? size);

  StarNode layoutAlign(LayoutAlign? layoutAlign);

  StarNode layoutGrow(LayoutGrow layoutGrow);

  StarNode layoutPositioning(LayoutPositioning layoutPositioning);

  StarNode minWidth(num minWidth);

  StarNode maxWidth(num maxWidth);

  StarNode minHeight(num minHeight);

  StarNode maxHeight(num maxHeight);

  StarNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  StarNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  StarNode gridRowCount(num? gridRowCount);

  StarNode gridColumnCount(num? gridColumnCount);

  StarNode gridRowGap(num gridRowGap);

  StarNode gridColumnGap(num gridColumnGap);

  StarNode gridColumnsSizing(String? gridColumnsSizing);

  StarNode gridRowsSizing(String? gridRowsSizing);

  StarNode gridChildHorizontalAlign(GridChildAlign? gridChildHorizontalAlign);

  StarNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  StarNode gridRowSpan(num gridRowSpan);

  StarNode gridColumnSpan(num gridColumnSpan);

  StarNode gridRowAnchorIndex(num gridRowAnchorIndex);

  StarNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  StarNode fillOverrideTable(Map<String, PaintOverride?> fillOverrideTable);

  StarNode fillGeometry(List<Path> fillGeometry);

  StarNode strokeGeometry(List<Path> strokeGeometry);

  StarNode strokeCap(StrokeCap strokeCap);

  StarNode strokeMiterAngle(num strokeMiterAngle);

  StarNode fills(List<Paint> fills);

  StarNode styles(Map<String, String> styles);

  StarNode strokes(List<Paint> strokes);

  StarNode strokeWeight(num strokeWeight);

  StarNode strokeAlign(StrokeAlign? strokeAlign);

  StarNode strokeJoin(StrokeJoin strokeJoin);

  StarNode strokeDashes(List<num> strokeDashes);

  StarNode exportSettings(List<ExportSetting> exportSettings);

  StarNode effects(List<Effect> effects);

  StarNode isMask(bool isMask);

  StarNode maskType(MaskType? maskType);

  StarNode transitionNodeId(String? transitionNodeId);

  StarNode transitionDuration(num? transitionDuration);

  StarNode transitionEasing(EasingType? transitionEasing);

  StarNode interactions(List<Interaction> interactions);

  StarNode cornerRadius(num cornerRadius);

  StarNode cornerSmoothing(num cornerSmoothing);
...
/// Use as `instanceOfStarNode.copyWith(...)` or call `instanceOfStarNode.copyWith.fieldName(value)` for a single field.
class _$StarNodeCWProxyImpl implements _$StarNodeCWProxy {
  const _$StarNodeCWProxyImpl(this._value);

  final StarNode _value;

  @override
  StarNode id(String id) => call(id: id);

  @override
  StarNode name(String name) => call(name: name);

  @override
  StarNode visible(bool visible) => call(visible: visible);

  @override
  StarNode locked(bool locked) => call(locked: locked);
  ...
  @override
  StarNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  StarNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  StarNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  StarNode opacity(num opacity) => call(opacity: opacity);
  ...
  @override
  StarNode size(Vector? size) => call(size: size);
  ...
  @override
  StarNode layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  StarNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  StarNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  StarNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  StarNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  StarNode gridRowCount(num? gridRowCount) => call(gridRowCount: gridRowCount);
  ...
  @override
  StarNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  StarNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  StarNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  StarNode fills(List<Paint> fills) => call(fills: fills);

  @override
  StarNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  StarNode strokes(List<Paint> strokes) => call(strokes: strokes);

  @override
  StarNode strokeWeight(num strokeWeight) => call(strokeWeight: strokeWeight);
  ...
  @override
  StarNode strokeJoin(StrokeJoin strokeJoin) => call(strokeJoin: strokeJoin);
  ...
  @override
  StarNode effects(List<Effect> effects) => call(effects: effects);

  @override
  StarNode isMask(bool isMask) => call(isMask: isMask);

  @override
  StarNode maskType(MaskType? maskType) => call(maskType: maskType);
  ...
  @override
  StarNode cornerRadius(num cornerRadius) => call(cornerRadius: cornerRadius);
...
extension $StarNodeCopyWith on StarNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfStarNode.copyWith(...)` or `instanceOfStarNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$StarNodeCWProxy get copyWith => _$StarNodeCWProxyImpl(this);
}
...
StarNode _$StarNodeFromJson(Map<String, dynamic> json) => StarNode(
...
Map<String, dynamic> _$StarNodeToJson(StarNode instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
