...
abstract class _$ConnectorNodeCWProxy {
  ConnectorNode id(String id);

  ConnectorNode name(String name);

  ConnectorNode visible(bool visible);

  ConnectorNode locked(bool locked);

  ConnectorNode scrollBehavior(ScrollBehavior scrollBehavior);

  ConnectorNode rotation(num rotation);

  ConnectorNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  ConnectorNode pluginData(Object? pluginData);

  ConnectorNode sharedPluginData(Object? sharedPluginData);

  ConnectorNode boundVariables(LayerTraitVariables boundVariables);

  ConnectorNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  ConnectorNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  ConnectorNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  ConnectorNode preserveRatio(bool preserveRatio);

  ConnectorNode constraints(LayoutConstraint? constraints);

  ConnectorNode relativeTransform(Transform? relativeTransform);

  ConnectorNode size(Vector? size);

  ConnectorNode layoutAlign(LayoutAlign? layoutAlign);

  ConnectorNode layoutGrow(LayoutGrow layoutGrow);

  ConnectorNode layoutPositioning(LayoutPositioning layoutPositioning);

  ConnectorNode minWidth(num minWidth);

  ConnectorNode maxWidth(num maxWidth);

  ConnectorNode minHeight(num minHeight);

  ConnectorNode maxHeight(num maxHeight);

  ConnectorNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  ConnectorNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  ConnectorNode gridRowCount(num? gridRowCount);

  ConnectorNode gridColumnCount(num? gridColumnCount);

  ConnectorNode gridRowGap(num gridRowGap);

  ConnectorNode gridColumnGap(num gridColumnGap);

  ConnectorNode gridColumnsSizing(String? gridColumnsSizing);

  ConnectorNode gridRowsSizing(String? gridRowsSizing);

  ConnectorNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  ConnectorNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  ConnectorNode gridRowSpan(num gridRowSpan);

  ConnectorNode gridColumnSpan(num gridColumnSpan);

  ConnectorNode gridRowAnchorIndex(num gridRowAnchorIndex);

  ConnectorNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  ConnectorNode blendMode(BlendMode blendMode);

  ConnectorNode opacity(num opacity);

  ConnectorNode effects(List<Effect> effects);

  ConnectorNode exportSettings(List<ExportSetting> exportSettings);

  ConnectorNode characters(String characters);

  ConnectorNode strokes(List<Paint> strokes);

  ConnectorNode strokeWeight(num strokeWeight);

  ConnectorNode strokeAlign(StrokeAlign? strokeAlign);

  ConnectorNode strokeJoin(StrokeJoin strokeJoin);

  ConnectorNode strokeDashes(List<num> strokeDashes);

  ConnectorNode connectorStart(ConnectorEndpoint connectorStart);

  ConnectorNode connectorEnd(ConnectorEndpoint connectorEnd);

  ConnectorNode connectorStartStrokeCap(
    ConnectorStrokeCap connectorStartStrokeCap,
  );

  ConnectorNode connectorEndStrokeCap(ConnectorStrokeCap connectorEndStrokeCap);

  ConnectorNode connectorLineType(ConnectorLineType connectorLineType);
  ...
  ConnectorNode call({
    ...
    ConnectorStrokeCap connectorStartStrokeCap,
    ConnectorStrokeCap connectorEndStrokeCap,
...
/// Use as `instanceOfConnectorNode.copyWith(...)` or call `instanceOfConnectorNode.copyWith.fieldName(value)` for a single field.
class _$ConnectorNodeCWProxyImpl implements _$ConnectorNodeCWProxy {
  const _$ConnectorNodeCWProxyImpl(this._value);

  final ConnectorNode _value;

  @override
  ConnectorNode id(String id) => call(id: id);

  @override
  ConnectorNode name(String name) => call(name: name);

  @override
  ConnectorNode visible(bool visible) => call(visible: visible);

  @override
  ConnectorNode locked(bool locked) => call(locked: locked);
  ...
  @override
  ConnectorNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  ConnectorNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  ConnectorNode size(Vector? size) => call(size: size);
  ...
  @override
  ConnectorNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  ConnectorNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  ConnectorNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  ConnectorNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  ConnectorNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  ConnectorNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  ) => call(gridChildVerticalAlign: gridChildVerticalAlign);

  @override
  ConnectorNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  ConnectorNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  ConnectorNode opacity(num opacity) => call(opacity: opacity);

  @override
  ConnectorNode effects(List<Effect> effects) => call(effects: effects);
  ...
  @override
  ConnectorNode characters(String characters) => call(characters: characters);

  @override
  ConnectorNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  ConnectorNode connectorStart(ConnectorEndpoint connectorStart) =>
      call(connectorStart: connectorStart);

  @override
  ConnectorNode connectorEnd(ConnectorEndpoint connectorEnd) =>
      call(connectorEnd: connectorEnd);

  @override
  ConnectorNode connectorStartStrokeCap(
    ConnectorStrokeCap connectorStartStrokeCap,
  ) => call(connectorStartStrokeCap: connectorStartStrokeCap);

  @override
  ConnectorNode connectorEndStrokeCap(
    ConnectorStrokeCap connectorEndStrokeCap,
  ) => call(connectorEndStrokeCap: connectorEndStrokeCap);

  @override
  ConnectorNode connectorLineType(ConnectorLineType connectorLineType) =>
      call(connectorLineType: connectorLineType);
  ...
  ConnectorNode call({
    ...
    Object? connectorStart = const $CopyWithPlaceholder(),
    Object? connectorEnd = const $CopyWithPlaceholder(),
    Object? connectorStartStrokeCap = const $CopyWithPlaceholder(),
    Object? connectorEndStrokeCap = const $CopyWithPlaceholder(),
    Object? connectorLineType = const $CopyWithPlaceholder(),
    Object? textBackground = const $CopyWithPlaceholder(),
  }) {
    return ConnectorNode(
      ...
      connectorStart:
          connectorStart == const $CopyWithPlaceholder() ||
              connectorStart == null
          ? _value.connectorStart
          // ignore: cast_nullable_to_non_nullable
          : connectorStart as ConnectorEndpoint,
      connectorEnd:
          connectorEnd == const $CopyWithPlaceholder() || connectorEnd == null
          ? _value.connectorEnd
          // ignore: cast_nullable_to_non_nullable
          : connectorEnd as ConnectorEndpoint,
      connectorStartStrokeCap:
          connectorStartStrokeCap == const $CopyWithPlaceholder() ||
              connectorStartStrokeCap == null
          ? _value.connectorStartStrokeCap
          // ignore: cast_nullable_to_non_nullable
          : connectorStartStrokeCap as ConnectorStrokeCap,
      connectorEndStrokeCap:
          connectorEndStrokeCap == const $CopyWithPlaceholder() ||
              connectorEndStrokeCap == null
          ? _value.connectorEndStrokeCap
          // ignore: cast_nullable_to_non_nullable
          : connectorEndStrokeCap as ConnectorStrokeCap,
      connectorLineType:
          connectorLineType == const $CopyWithPlaceholder() ||
              connectorLineType == null
          ? _value.connectorLineType
          // ignore: cast_nullable_to_non_nullable
          : connectorLineType as ConnectorLineType,
      textBackground: textBackground == const $CopyWithPlaceholder()
          ? _value.textBackground
          // ignore: cast_nullable_to_non_nullable
          : textBackground as ConnectorTextBackground?,
    );
  }
}

extension $ConnectorNodeCopyWith on ConnectorNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfConnectorNode.copyWith(...)` or `instanceOfConnectorNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ConnectorNodeCWProxy get copyWith => _$ConnectorNodeCWProxyImpl(this);
}
...
ConnectorNode _$ConnectorNodeFromJson(
  ...
  strokeDashes:
      ...
      [],
  connectorStart: ConnectorEndpoint.fromJson(
    json['connectorStart'] as Map<String, dynamic>,
  ),
  connectorEnd: ConnectorEndpoint.fromJson(
    json['connectorEnd'] as Map<String, dynamic>,
  ),
  connectorStartStrokeCap: $enumDecode(
    _$ConnectorStrokeCapEnumMap,
    json['connectorStartStrokeCap'],
  ),
  connectorEndStrokeCap: $enumDecode(
    _$ConnectorStrokeCapEnumMap,
    json['connectorEndStrokeCap'],
  ),
  connectorLineType: $enumDecode(
    _$ConnectorLineTypeEnumMap,
    json['connectorLineType'],
  ),
  textBackground: json['textBackground'] == null
      ? null
      : ConnectorTextBackground.fromJson(
          json['textBackground'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ConnectorNodeToJson(
  ConnectorNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  ...
  'connectorStart': instance.connectorStart.toJson(),
  'connectorEnd': instance.connectorEnd.toJson(),
  'connectorStartStrokeCap':
      _$ConnectorStrokeCapEnumMap[instance.connectorStartStrokeCap]!,
  'connectorEndStrokeCap':
      _$ConnectorStrokeCapEnumMap[instance.connectorEndStrokeCap]!,
  'connectorLineType': _$ConnectorLineTypeEnumMap[instance.connectorLineType]!,
  'textBackground': ?instance.textBackground?.toJson(),
...
const _$ConnectorStrokeCapEnumMap = {
  ConnectorStrokeCap.none: 'NONE',
  ConnectorStrokeCap.lineArrow: 'LINE_ARROW',
  ConnectorStrokeCap.triangleArrow: 'TRIANGLE_ARROW',
  ConnectorStrokeCap.diamondFilled: 'DIAMOND_FILLED',
  ConnectorStrokeCap.circleFilled: 'CIRCLE_FILLED',
  ConnectorStrokeCap.triangleFilled: 'TRIANGLE_FILLED',
};

const _$ConnectorLineTypeEnumMap = {
  ConnectorLineType.straight: 'STRAIGHT',
  ConnectorLineType.elbowed: 'ELBOWED',
  ConnectorLineType.curved: 'CURVED',
};
