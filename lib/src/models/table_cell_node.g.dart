...
part of 'table_cell_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$TableCellNodeCWProxy {
  TableCellNode id(String id);

  TableCellNode name(String name);

  TableCellNode visible(bool visible);

  TableCellNode locked(bool locked);

  TableCellNode scrollBehavior(ScrollBehavior scrollBehavior);

  TableCellNode rotation(num rotation);

  TableCellNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  TableCellNode pluginData(Object? pluginData);

  TableCellNode sharedPluginData(Object? sharedPluginData);

  TableCellNode boundVariables(LayerTraitVariables boundVariables);

  TableCellNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  TableCellNode fills(List<Paint> fills);

  TableCellNode styles(Map<String, String> styles);

  TableCellNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  TableCellNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  TableCellNode preserveRatio(bool preserveRatio);

  TableCellNode constraints(LayoutConstraint? constraints);

  TableCellNode relativeTransform(Transform? relativeTransform);

  TableCellNode size(Vector? size);

  TableCellNode layoutAlign(LayoutAlign? layoutAlign);

  TableCellNode layoutGrow(LayoutGrow layoutGrow);

  TableCellNode layoutPositioning(LayoutPositioning layoutPositioning);

  TableCellNode minWidth(num minWidth);

  TableCellNode maxWidth(num maxWidth);

  TableCellNode minHeight(num minHeight);

  TableCellNode maxHeight(num maxHeight);

  TableCellNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  TableCellNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  TableCellNode gridRowCount(num? gridRowCount);

  TableCellNode gridColumnCount(num? gridColumnCount);

  TableCellNode gridRowGap(num gridRowGap);

  TableCellNode gridColumnGap(num gridColumnGap);

  TableCellNode gridColumnsSizing(String? gridColumnsSizing);

  TableCellNode gridRowsSizing(String? gridRowsSizing);

  TableCellNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  TableCellNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  TableCellNode gridRowSpan(num gridRowSpan);

  TableCellNode gridColumnSpan(num gridColumnSpan);

  TableCellNode gridRowAnchorIndex(num gridRowAnchorIndex);

  TableCellNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  TableCellNode characters(String characters);
...
/// Use as `instanceOfTableCellNode.copyWith(...)` or call `instanceOfTableCellNode.copyWith.fieldName(value)` for a single field.
class _$TableCellNodeCWProxyImpl implements _$TableCellNodeCWProxy {
  const _$TableCellNodeCWProxyImpl(this._value);

  final TableCellNode _value;

  @override
  TableCellNode id(String id) => call(id: id);

  @override
  TableCellNode name(String name) => call(name: name);

  @override
  TableCellNode visible(bool visible) => call(visible: visible);

  @override
  TableCellNode locked(bool locked) => call(locked: locked);
  ...
  @override
  TableCellNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  TableCellNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  TableCellNode fills(List<Paint> fills) => call(fills: fills);

  @override
  TableCellNode styles(Map<String, String> styles) => call(styles: styles);
  ...
  @override
  TableCellNode size(Vector? size) => call(size: size);
  ...
  @override
  TableCellNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  TableCellNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  TableCellNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  TableCellNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  TableCellNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  TableCellNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  ) => call(gridChildVerticalAlign: gridChildVerticalAlign);

  @override
  TableCellNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
...
extension $TableCellNodeCopyWith on TableCellNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfTableCellNode.copyWith(...)` or `instanceOfTableCellNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$TableCellNodeCWProxy get copyWith => _$TableCellNodeCWProxyImpl(this);
}
...
TableCellNode _$TableCellNodeFromJson(
...
Map<String, dynamic> _$TableCellNodeToJson(
  TableCellNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
