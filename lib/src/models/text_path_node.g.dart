...
part of 'text_path_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$TextPathNodeCWProxy {
  TextPathNode id(String id);

  TextPathNode name(String name);

  TextPathNode visible(bool visible);

  TextPathNode locked(bool locked);

  TextPathNode scrollBehavior(ScrollBehavior scrollBehavior);

  TextPathNode rotation(num rotation);

  TextPathNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  TextPathNode pluginData(Object? pluginData);

  TextPathNode sharedPluginData(Object? sharedPluginData);

  TextPathNode boundVariables(LayerTraitVariables boundVariables);

  TextPathNode explicitVariableModes(Map<String, String> explicitVariableModes);

  TextPathNode blendMode(BlendMode blendMode);

  TextPathNode opacity(num opacity);

  TextPathNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  TextPathNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  TextPathNode preserveRatio(bool preserveRatio);

  TextPathNode constraints(LayoutConstraint? constraints);

  TextPathNode relativeTransform(Transform? relativeTransform);

  TextPathNode size(Vector? size);

  TextPathNode layoutAlign(LayoutAlign? layoutAlign);

  TextPathNode layoutGrow(LayoutGrow layoutGrow);

  TextPathNode layoutPositioning(LayoutPositioning layoutPositioning);

  TextPathNode minWidth(num minWidth);

  TextPathNode maxWidth(num maxWidth);

  TextPathNode minHeight(num minHeight);

  TextPathNode maxHeight(num maxHeight);

  TextPathNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  TextPathNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  TextPathNode gridRowCount(num? gridRowCount);

  TextPathNode gridColumnCount(num? gridColumnCount);

  TextPathNode gridRowGap(num gridRowGap);

  TextPathNode gridColumnGap(num gridColumnGap);

  TextPathNode gridColumnsSizing(String? gridColumnsSizing);

  TextPathNode gridRowsSizing(String? gridRowsSizing);

  TextPathNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  TextPathNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  TextPathNode gridRowSpan(num gridRowSpan);

  TextPathNode gridColumnSpan(num gridColumnSpan);

  TextPathNode gridRowAnchorIndex(num gridRowAnchorIndex);

  TextPathNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  TextPathNode fills(List<Paint> fills);

  TextPathNode styles(Map<String, String> styles);

  TextPathNode strokes(List<Paint> strokes);

  TextPathNode strokeWeight(num strokeWeight);

  TextPathNode strokeAlign(StrokeAlign? strokeAlign);

  TextPathNode strokeJoin(StrokeJoin strokeJoin);

  TextPathNode strokeDashes(List<num> strokeDashes);

  TextPathNode fillOverrideTable(Map<String, PaintOverride?> fillOverrideTable);

  TextPathNode fillGeometry(List<Path> fillGeometry);

  TextPathNode strokeGeometry(List<Path> strokeGeometry);

  TextPathNode strokeCap(StrokeCap strokeCap);

  TextPathNode strokeMiterAngle(num strokeMiterAngle);

  TextPathNode exportSettings(List<ExportSetting> exportSettings);

  TextPathNode effects(List<Effect> effects);

  TextPathNode isMask(bool isMask);

  TextPathNode maskType(MaskType? maskType);

  TextPathNode transitionNodeId(String? transitionNodeId);

  TextPathNode transitionDuration(num? transitionDuration);

  TextPathNode transitionEasing(EasingType? transitionEasing);

  TextPathNode interactions(List<Interaction> interactions);

  TextPathNode characters(String characters);

  TextPathNode style(TextPathTypeStyle style);

  TextPathNode characterStyleOverrides(List<num> characterStyleOverrides);

  TextPathNode layoutVersion(num? layoutVersion);

  TextPathNode styleOverrideTable(
    Map<String, TextPathTypeStyle> styleOverrideTable,
  );

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `TextPathNode(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// TextPathNode(...).copyWith(id: 12, name: "My name")
  /// ```
  TextPathNode call({
    String id,
    String name,
    ...
    List<num> characterStyleOverrides,
    num? layoutVersion,
    Map<String, TextPathTypeStyle> styleOverrideTable,
  });
}
...
/// Use as `instanceOfTextPathNode.copyWith(...)` or call `instanceOfTextPathNode.copyWith.fieldName(value)` for a single field.
class _$TextPathNodeCWProxyImpl implements _$TextPathNodeCWProxy {
  const _$TextPathNodeCWProxyImpl(this._value);

  final TextPathNode _value;

  @override
  TextPathNode id(String id) => call(id: id);

  @override
  TextPathNode name(String name) => call(name: name);

  @override
  TextPathNode visible(bool visible) => call(visible: visible);

  @override
  TextPathNode locked(bool locked) => call(locked: locked);
  ...
  @override
  TextPathNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  TextPathNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  TextPathNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  ) => call(explicitVariableModes: explicitVariableModes);

  @override
  TextPathNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  TextPathNode opacity(num opacity) => call(opacity: opacity);
  ...
  @override
  TextPathNode size(Vector? size) => call(size: size);
  ...
  @override
  TextPathNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  TextPathNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  TextPathNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  TextPathNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  TextPathNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  TextPathNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  TextPathNode fills(List<Paint> fills) => call(fills: fills);

  @override
  TextPathNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  TextPathNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  TextPathNode fillOverrideTable(
    Map<String, PaintOverride?> fillOverrideTable,
  ...
  @override
  TextPathNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  TextPathNode effects(List<Effect> effects) => call(effects: effects);

  @override
  TextPathNode isMask(bool isMask) => call(isMask: isMask);

  @override
  TextPathNode maskType(MaskType? maskType) => call(maskType: maskType);
  ...
  @override
  TextPathNode characters(String characters) => call(characters: characters);

  @override
  TextPathNode style(TextPathTypeStyle style) => call(style: style);

  @override
  TextPathNode characterStyleOverrides(List<num> characterStyleOverrides) =>
      call(characterStyleOverrides: characterStyleOverrides);

  @override
  TextPathNode layoutVersion(num? layoutVersion) =>
      call(layoutVersion: layoutVersion);

  @override
  TextPathNode styleOverrideTable(
    Map<String, TextPathTypeStyle> styleOverrideTable,
  ) => call(styleOverrideTable: styleOverrideTable);
  ...
  TextPathNode call({
    ...
    Object? characterStyleOverrides = const $CopyWithPlaceholder(),
    Object? layoutVersion = const $CopyWithPlaceholder(),
    Object? styleOverrideTable = const $CopyWithPlaceholder(),
  }) {
    return TextPathNode(
      ...
      style: style == const $CopyWithPlaceholder() || style == null
          ? _value.style
          // ignore: cast_nullable_to_non_nullable
          : style as TextPathTypeStyle,
      characterStyleOverrides:
          characterStyleOverrides == const $CopyWithPlaceholder() ||
              characterStyleOverrides == null
          ? _value.characterStyleOverrides
          // ignore: cast_nullable_to_non_nullable
          : characterStyleOverrides as List<num>,
      layoutVersion: layoutVersion == const $CopyWithPlaceholder()
          ? _value.layoutVersion
          // ignore: cast_nullable_to_non_nullable
          : layoutVersion as num?,
      styleOverrideTable:
          styleOverrideTable == const $CopyWithPlaceholder() ||
              styleOverrideTable == null
          ? _value.styleOverrideTable
          // ignore: cast_nullable_to_non_nullable
          : styleOverrideTable as Map<String, TextPathTypeStyle>,
    );
  }
}

extension $TextPathNodeCopyWith on TextPathNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfTextPathNode.copyWith(...)` or `instanceOfTextPathNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$TextPathNodeCWProxy get copyWith => _$TextPathNodeCWProxyImpl(this);
}
...
TextPathNode _$TextPathNodeFromJson(Map<String, dynamic> json) => TextPathNode(
  ...
  style: TextPathTypeStyle.fromJson(json['style'] as Map<String, dynamic>),
  characterStyleOverrides: (json['characterStyleOverrides'] as List<dynamic>)
      .map((e) => e as num)
      .toList(),
  layoutVersion: json['layoutVersion'] as num?,
  styleOverrideTable: (json['styleOverrideTable'] as Map<String, dynamic>).map(
    (k, e) =>
        MapEntry(k, TextPathTypeStyle.fromJson(e as Map<String, dynamic>)),
  ),
);

Map<String, dynamic> _$TextPathNodeToJson(
  TextPathNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  ...
  'styleOverrideTable': instance.styleOverrideTable.map(
    (k, e) => MapEntry(k, e.toJson()),
  ),
