...
import 'rectangular_shape_traits.dart';
...
@CopyWith()
@immutable
class RectangleNode extends SubCanvasNode with RectangularShapeTraits {
  const RectangleNode({
    required this.id,
    required this.name,
    this.visible = true,
  ...
  factory RectangleNode.fromJson(Map<String, Object?> json) =>
  ...
  @override
  NodeType get type => NodeType.rectangle;

  @override
  List<Object?> get props => <Object?>[...super.props];

  @override
  Map<String, Object?> toJson() => _$RectangleNodeToJson(this);
}
