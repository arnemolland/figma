  ...
  LibraryPublishPayload call({
    ...
    return LibraryPublishPayload(
      ...
      fileName: fileName == const $CopyWithPlaceholder() || fileName == null
          ...
          : fileName as String,
      libraryItem:
          libraryItem == const $CopyWithPlaceholder() || libraryItem == null
          ? _value.libraryItem
          // ignore: cast_nullable_to_non_nullable
...
LibraryPublishPayload _$LibraryPublishPayloadFromJson(
  ...
  libraryItem: LibraryItemData.fromJson(
