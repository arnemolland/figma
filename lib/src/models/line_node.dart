...
part 'line_node.g.dart';

@JsonSerializable(explicitToJson: true)
@CopyWith()
@immutable
class LineNode extends SubCanvasNode with DefaultShapeTraits, AnnotationsTrait {
  const LineNode({
    required this.id,
    required this.name,
    this.visible = true,
  ...
  factory LineNode.fromJson(Map<String, Object?> json) =>
      _$LineNodeFromJson(json);
  ...
  @override
  NodeType get type => NodeType.line;

  @override
  List<Object?> get props => <Object?>[...super.props];

  @override
  Map<String, Object?> toJson() => _$LineNodeToJson(this);
}
