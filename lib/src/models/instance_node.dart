...
import 'component_property.dart';
...
@CopyWith()
@immutable
class InstanceNode extends SubCanvasNode with FrameTraits {
  const InstanceNode({
    required this.id,
    required this.name,
    this.visible = true,
    ...
    this.exposedInstances = const [],
    this.componentProperties = const {},
    required this.overrides,
  });

  factory InstanceNode.fromJson(Map<String, Object?> json) =>
      _$InstanceNodeFromJson(json);
  ...
  /// If true, this node has been marked as exposed to its containing component
  /// or component set.
  @JsonKey(defaultValue: false)
  ...
  @override
  NodeType get type => NodeType.instance;
  ...
  @override
  Map<String, Object?> toJson() => _$InstanceNodeToJson(this);
}
