...
@CopyWith()
@immutable
class StarNode extends SubCanvasNode
  ...
  factory StarNode.fromJson(Map<String, Object?> json) =>
      _$StarNodeFromJson(json);
  ...
  @override
  NodeType get type => NodeType.star;

  @override
  List<Object?> get props => <Object?>[...super.props];

  @override
  Map<String, Object?> toJson() => _$StarNodeToJson(this);
}
