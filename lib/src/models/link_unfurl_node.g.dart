...
part of 'link_unfurl_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$LinkUnfurlNodeCWProxy {
  LinkUnfurlNode id(String id);

  LinkUnfurlNode name(String name);

  LinkUnfurlNode visible(bool visible);

  LinkUnfurlNode locked(bool locked);

  LinkUnfurlNode scrollBehavior(ScrollBehavior scrollBehavior);

  LinkUnfurlNode rotation(num rotation);

  LinkUnfurlNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  LinkUnfurlNode pluginData(Object? pluginData);

  LinkUnfurlNode sharedPluginData(Object? sharedPluginData);

  LinkUnfurlNode boundVariables(LayerTraitVariables boundVariables);

  LinkUnfurlNode explicitVariableModes(
...
/// Use as `instanceOfLinkUnfurlNode.copyWith(...)` or call `instanceOfLinkUnfurlNode.copyWith.fieldName(value)` for a single field.
class _$LinkUnfurlNodeCWProxyImpl implements _$LinkUnfurlNodeCWProxy {
  const _$LinkUnfurlNodeCWProxyImpl(this._value);

  final LinkUnfurlNode _value;

  @override
  LinkUnfurlNode id(String id) => call(id: id);

  @override
  LinkUnfurlNode name(String name) => call(name: name);

  @override
  LinkUnfurlNode visible(bool visible) => call(visible: visible);

  @override
  LinkUnfurlNode locked(bool locked) => call(locked: locked);
  ...
  @override
  LinkUnfurlNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  LinkUnfurlNode pluginData(Object? pluginData) => call(pluginData: pluginData);
...
extension $LinkUnfurlNodeCopyWith on LinkUnfurlNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfLinkUnfurlNode.copyWith(...)` or `instanceOfLinkUnfurlNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$LinkUnfurlNodeCWProxy get copyWith => _$LinkUnfurlNodeCWProxyImpl(this);
}
...
LinkUnfurlNode _$LinkUnfurlNodeFromJson(Map<String, dynamic> json) =>
    LinkUnfurlNode(
      id: json['id'] as String,
      name: json['name'] as String,
      visible: json['visible'] as bool? ?? true,
      locked: json['locked'] as bool? ?? false,
      scrollBehavior: $enumDecode(
        _$ScrollBehaviorEnumMap,
        json['scrollBehavior'],
      ),
...
Map<String, dynamic> _$LinkUnfurlNodeToJson(LinkUnfurlNode instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
