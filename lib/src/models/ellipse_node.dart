...
@CopyWith()
@immutable
class EllipseNode extends SubCanvasNode
    with DefaultShapeTraits, AnnotationsTrait {
  const EllipseNode({
    required this.id,
    required this.name,
    this.visible = true,
  ...
  factory EllipseNode.fromJson(Map<String, Object?> json) =>
      _$EllipseNodeFromJson(json);
  ...
  @override
  NodeType get type => NodeType.ellipse;

  @override
  List<Object?> get props => <Object?>[...super.props, arcData];

  @override
  Map<String, Object?> toJson() => _$EllipseNodeToJson(this);
}
