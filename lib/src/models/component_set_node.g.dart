...
part of 'component_set_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ComponentSetNodeCWProxy {
  ComponentSetNode id(String id);

  ComponentSetNode name(String name);

  ComponentSetNode visible(bool visible);

  ComponentSetNode locked(bool locked);

  ComponentSetNode scrollBehavior(ScrollBehavior scrollBehavior);

  ComponentSetNode rotation(num rotation);

  ComponentSetNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  ComponentSetNode pluginData(Object? pluginData);

  ComponentSetNode sharedPluginData(Object? sharedPluginData);

  ComponentSetNode boundVariables(LayerTraitVariables boundVariables);

  ComponentSetNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  ComponentSetNode blendMode(BlendMode blendMode);

  ComponentSetNode opacity(num opacity);

  ComponentSetNode children(List<SubCanvasNode> children);

  ComponentSetNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  ComponentSetNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  ComponentSetNode preserveRatio(bool preserveRatio);

  ComponentSetNode constraints(LayoutConstraint? constraints);

  ComponentSetNode relativeTransform(Transform? relativeTransform);

  ComponentSetNode size(Vector? size);

  ComponentSetNode layoutAlign(LayoutAlign? layoutAlign);

  ComponentSetNode layoutGrow(LayoutGrow layoutGrow);

  ComponentSetNode layoutPositioning(LayoutPositioning layoutPositioning);

  ComponentSetNode minWidth(num minWidth);

  ComponentSetNode maxWidth(num maxWidth);

  ComponentSetNode minHeight(num minHeight);

  ComponentSetNode maxHeight(num maxHeight);

  ComponentSetNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  ComponentSetNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  ComponentSetNode gridRowCount(num? gridRowCount);

  ComponentSetNode gridColumnCount(num? gridColumnCount);

  ComponentSetNode gridRowGap(num gridRowGap);

  ComponentSetNode gridColumnGap(num gridColumnGap);

  ComponentSetNode gridColumnsSizing(String? gridColumnsSizing);

  ComponentSetNode gridRowsSizing(String? gridRowsSizing);

  ComponentSetNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  ComponentSetNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  );

  ComponentSetNode gridRowSpan(num gridRowSpan);

  ComponentSetNode gridColumnSpan(num gridColumnSpan);

  ComponentSetNode gridRowAnchorIndex(num gridRowAnchorIndex);

  ComponentSetNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  ComponentSetNode clipsContent(bool clipsContent);

  ComponentSetNode layoutGrids(List<LayoutGrid> layoutGrids);

  ComponentSetNode overflowDirection(OverflowDirection overflowDirection);

  ComponentSetNode layoutMode(LayoutMode layoutMode);

  ComponentSetNode primaryAxisSizingMode(
    PrimaryAxisSizingMode primaryAxisSizingMode,
  );

  ComponentSetNode counterAxisSizingMode(
    CounterAxisSizingMode counterAxisSizingMode,
  );

  ComponentSetNode primaryAxisAlignItems(
    PrimaryAxisAlignItems primaryAxisAlignItems,
  );

  ComponentSetNode counterAxisAlignItems(
    CounterAxisAlignItems counterAxisAlignItems,
  );

  ComponentSetNode paddingLeft(num paddingLeft);

  ComponentSetNode paddingRight(num paddingRight);

  ComponentSetNode paddingTop(num paddingTop);

  ComponentSetNode paddingBottom(num paddingBottom);

  ComponentSetNode itemSpacing(num itemSpacing);

  ComponentSetNode itemReverseZIndex(bool itemReverseZIndex);

  ComponentSetNode strokesIncludedInLayout(bool strokesIncludedInLayout);

  ComponentSetNode layoutWrap(LayoutWrap? layoutWrap);

  ComponentSetNode counterAxisSpacing(num? counterAxisSpacing);

  ComponentSetNode counterAxisAlignContent(
    CounterAxisAlignContent counterAxisAlignContent,
  );

  ComponentSetNode cornerRadius(num cornerRadius);

  ComponentSetNode cornerSmoothing(num cornerSmoothing);

  ComponentSetNode rectangleCornerRadii(List<num> rectangleCornerRadii);

  ComponentSetNode fills(List<Paint> fills);

  ComponentSetNode styles(Map<String, String> styles);

  ComponentSetNode strokes(List<Paint> strokes);

  ComponentSetNode strokeWeight(num strokeWeight);

  ComponentSetNode strokeAlign(StrokeAlign? strokeAlign);

  ComponentSetNode strokeJoin(StrokeJoin strokeJoin);

  ComponentSetNode strokeDashes(List<num> strokeDashes);

  ComponentSetNode fillOverrideTable(
    Map<String, PaintOverride?> fillOverrideTable,
  );

  ComponentSetNode fillGeometry(List<Path> fillGeometry);

  ComponentSetNode strokeGeometry(List<Path> strokeGeometry);

  ComponentSetNode strokeCap(StrokeCap strokeCap);

  ComponentSetNode strokeMiterAngle(num strokeMiterAngle);

  ComponentSetNode exportSettings(List<ExportSetting> exportSettings);

  ComponentSetNode effects(List<Effect> effects);

  ComponentSetNode isMask(bool isMask);

  ComponentSetNode maskType(MaskType? maskType);

  ComponentSetNode transitionNodeId(String? transitionNodeId);

  ComponentSetNode transitionDuration(num? transitionDuration);

  ComponentSetNode transitionEasing(EasingType? transitionEasing);

  ComponentSetNode interactions(List<Interaction> interactions);

  ComponentSetNode individualStrokeWeights(
    StrokeWeights? individualStrokeWeights,
  );

  ComponentSetNode devStatus(DevStatus? devStatus);
...
/// Use as `instanceOfComponentSetNode.copyWith(...)` or call `instanceOfComponentSetNode.copyWith.fieldName(value)` for a single field.
class _$ComponentSetNodeCWProxyImpl implements _$ComponentSetNodeCWProxy {
  const _$ComponentSetNodeCWProxyImpl(this._value);

  final ComponentSetNode _value;

  @override
  ComponentSetNode id(String id) => call(id: id);

  @override
  ComponentSetNode name(String name) => call(name: name);

  @override
  ComponentSetNode visible(bool visible) => call(visible: visible);

  @override
  ComponentSetNode locked(bool locked) => call(locked: locked);
  ...
  @override
  ComponentSetNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  ComponentSetNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  ComponentSetNode opacity(num opacity) => call(opacity: opacity);
  ...
  @override
  ComponentSetNode size(Vector? size) => call(size: size);
  ...
  @override
  ComponentSetNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  ComponentSetNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  ComponentSetNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  ComponentSetNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);

  @override
  ComponentSetNode layoutSizingHorizontal(
    LayoutSizing? layoutSizingHorizontal,
  ...
  @override
  ComponentSetNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  ComponentSetNode paddingTop(num paddingTop) => call(paddingTop: paddingTop);
  ...
  @override
  ComponentSetNode fills(List<Paint> fills) => call(fills: fills);

  @override
  ComponentSetNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  ComponentSetNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  ComponentSetNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  ComponentSetNode effects(List<Effect> effects) => call(effects: effects);

  @override
  ComponentSetNode isMask(bool isMask) => call(isMask: isMask);

  @override
  ComponentSetNode maskType(MaskType? maskType) => call(maskType: maskType);
...
extension $ComponentSetNodeCopyWith on ComponentSetNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfComponentSetNode.copyWith(...)` or `instanceOfComponentSetNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ComponentSetNodeCWProxy get copyWith => _$ComponentSetNodeCWProxyImpl(this);
}
...
ComponentSetNode _$ComponentSetNodeFromJson(
...
Map<String, dynamic> _$ComponentSetNodeToJson(
  ComponentSetNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  ...
  'componentPropertyDefinitions': instance.componentPropertyDefinitions.map(
    (k, e) => MapEntry(k, e.toJson()),
  ),
