...
import 'type_properties_trait.dart';
...
@CopyWith()
@immutable
class TextNode extends SubCanvasNode
    with DefaultShapeTraits, TypePropertiesTrait, AnnotationsTrait {
  const TextNode({
    required this.id,
    required this.name,
    this.visible = true,
    ...
    required this.lineIndentations,
  });

  factory TextNode.fromJson(Map<String, Object?> json) =>
  ...
  @override
  final Map<String, TypeStyle> styleOverrideTable;

  @override
  final List<LineType> lineTypes;

  @override
  final List<num> lineIndentations;

  /// The type of this node, represented by the string literal "TEXT".
  @JsonKey(includeToJson: true)
  @override
  NodeType get type => NodeType.text;
  ...
  @override
  Map<String, Object?> toJson() => _$TextNodeToJson(this);
}
