...
part of 'shape_with_text_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ShapeWithTextNodeCWProxy {
  ShapeWithTextNode id(String id);

  ShapeWithTextNode name(String name);

  ShapeWithTextNode visible(bool visible);

  ShapeWithTextNode locked(bool locked);

  ShapeWithTextNode scrollBehavior(ScrollBehavior scrollBehavior);

  ShapeWithTextNode rotation(num rotation);

  ShapeWithTextNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  ShapeWithTextNode pluginData(Object? pluginData);

  ShapeWithTextNode sharedPluginData(Object? sharedPluginData);

  ShapeWithTextNode boundVariables(LayerTraitVariables boundVariables);

  ShapeWithTextNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  ShapeWithTextNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  ShapeWithTextNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  ShapeWithTextNode preserveRatio(bool preserveRatio);

  ShapeWithTextNode constraints(LayoutConstraint? constraints);

  ShapeWithTextNode relativeTransform(Transform? relativeTransform);

  ShapeWithTextNode size(Vector? size);

  ShapeWithTextNode layoutAlign(LayoutAlign? layoutAlign);

  ShapeWithTextNode layoutGrow(LayoutGrow layoutGrow);

  ShapeWithTextNode layoutPositioning(LayoutPositioning layoutPositioning);

  ShapeWithTextNode minWidth(num minWidth);

  ShapeWithTextNode maxWidth(num maxWidth);

  ShapeWithTextNode minHeight(num minHeight);

  ShapeWithTextNode maxHeight(num maxHeight);

  ShapeWithTextNode layoutSizingHorizontal(
    LayoutSizing? layoutSizingHorizontal,
  );

  ShapeWithTextNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  ShapeWithTextNode gridRowCount(num? gridRowCount);

  ShapeWithTextNode gridColumnCount(num? gridColumnCount);

  ShapeWithTextNode gridRowGap(num gridRowGap);

  ShapeWithTextNode gridColumnGap(num gridColumnGap);

  ShapeWithTextNode gridColumnsSizing(String? gridColumnsSizing);

  ShapeWithTextNode gridRowsSizing(String? gridRowsSizing);

  ShapeWithTextNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  ShapeWithTextNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  );

  ShapeWithTextNode gridRowSpan(num gridRowSpan);

  ShapeWithTextNode gridColumnSpan(num gridColumnSpan);

  ShapeWithTextNode gridRowAnchorIndex(num gridRowAnchorIndex);

  ShapeWithTextNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  ShapeWithTextNode blendMode(BlendMode blendMode);

  ShapeWithTextNode opacity(num opacity);

  ShapeWithTextNode fills(List<Paint> fills);

  ShapeWithTextNode styles(Map<String, String> styles);

  ShapeWithTextNode isMask(bool isMask);

  ShapeWithTextNode maskType(MaskType? maskType);

  ShapeWithTextNode effects(List<Effect> effects);

  ShapeWithTextNode exportSettings(List<ExportSetting> exportSettings);

  ShapeWithTextNode characters(String characters);

  ShapeWithTextNode cornerRadius(num cornerRadius);

  ShapeWithTextNode cornerSmoothing(num cornerSmoothing);

  ShapeWithTextNode rectangleCornerRadii(List<num> rectangleCornerRadii);

  ShapeWithTextNode strokes(List<Paint> strokes);

  ShapeWithTextNode strokeWeight(num strokeWeight);

  ShapeWithTextNode strokeAlign(StrokeAlign? strokeAlign);

  ShapeWithTextNode strokeJoin(StrokeJoin strokeJoin);

  ShapeWithTextNode strokeDashes(List<num> strokeDashes);
...
/// Use as `instanceOfShapeWithTextNode.copyWith(...)` or call `instanceOfShapeWithTextNode.copyWith.fieldName(value)` for a single field.
class _$ShapeWithTextNodeCWProxyImpl implements _$ShapeWithTextNodeCWProxy {
  const _$ShapeWithTextNodeCWProxyImpl(this._value);

  final ShapeWithTextNode _value;

  @override
  ShapeWithTextNode id(String id) => call(id: id);

  @override
  ShapeWithTextNode name(String name) => call(name: name);

  @override
  ShapeWithTextNode visible(bool visible) => call(visible: visible);

  @override
  ShapeWithTextNode locked(bool locked) => call(locked: locked);
  ...
  @override
  ShapeWithTextNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  ShapeWithTextNode size(Vector? size) => call(size: size);
  ...
  @override
  ShapeWithTextNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  ShapeWithTextNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  ShapeWithTextNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  ShapeWithTextNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  ShapeWithTextNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  ShapeWithTextNode opacity(num opacity) => call(opacity: opacity);

  @override
  ShapeWithTextNode fills(List<Paint> fills) => call(fills: fills);

  @override
  ShapeWithTextNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  ShapeWithTextNode isMask(bool isMask) => call(isMask: isMask);

  @override
  ShapeWithTextNode maskType(MaskType? maskType) => call(maskType: maskType);

  @override
  ShapeWithTextNode effects(List<Effect> effects) => call(effects: effects);
  ...
  @override
  ShapeWithTextNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  ShapeWithTextNode call({
    ...
    Object? shapeType = const $CopyWithPlaceholder(),
  }) {
    return ShapeWithTextNode(
      ...
      shapeType: shapeType == const $CopyWithPlaceholder() || shapeType == null
          ? _value.shapeType
          // ignore: cast_nullable_to_non_nullable
...
extension $ShapeWithTextNodeCopyWith on ShapeWithTextNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfShapeWithTextNode.copyWith(...)` or `instanceOfShapeWithTextNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ShapeWithTextNodeCWProxy get copyWith =>
      _$ShapeWithTextNodeCWProxyImpl(this);
}
...
ShapeWithTextNode _$ShapeWithTextNodeFromJson(
...
Map<String, dynamic> _$ShapeWithTextNodeToJson(
  ShapeWithTextNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
const _$ShapeTypeEnumMap = {
  ...
  ShapeType.triangleUp: 'TRIANGLE_UP',
  ShapeType.triangleDown: 'TRIANGLE_DOWN',
  ShapeType.parallelogramRight: 'PARALLELOGRAM_RIGHT',
  ShapeType.parallelogramLeft: 'PARALLELOGRAM_LEFT',
  ShapeType.engDatabase: 'ENG_DATABASE',
  ShapeType.engQueue: 'ENG_QUEUE',
  ShapeType.engFile: 'ENG_FILE',
  ShapeType.engFolder: 'ENG_FOLDER',
  ShapeType.trapezoid: 'TRAPEZOID',
  ShapeType.predefinedProcess: 'PREDEFINED_PROCESS',
  ShapeType.shield: 'SHIELD',
  ShapeType.documentSingle: 'DOCUMENT_SINGLE',
  ShapeType.documentMultiple: 'DOCUMENT_MULTIPLE',
  ShapeType.manualInput: 'MANUAL_INPUT',
  ...
  ShapeType.star: 'STAR',
  ShapeType.plus: 'PLUS',
  ShapeType.arrowLeft: 'ARROW_LEFT',
  ShapeType.arrowRight: 'ARROW_RIGHT',
  ShapeType.summingJunction: 'SUMMING_JUNCTION',
  ShapeType.or: 'OR',
  ShapeType.speechBubble: 'SPEECH_BUBBLE',
  ShapeType.internalStorage: 'INTERNAL_STORAGE',
};
