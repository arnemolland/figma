...
part of 'section_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$SectionNodeCWProxy {
  SectionNode id(String id);

  SectionNode name(String name);

  SectionNode visible(bool visible);

  SectionNode locked(bool locked);

  SectionNode scrollBehavior(ScrollBehavior scrollBehavior);

  SectionNode rotation(num rotation);

  SectionNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  SectionNode pluginData(Object? pluginData);

  SectionNode sharedPluginData(Object? sharedPluginData);

  SectionNode boundVariables(LayerTraitVariables boundVariables);

  SectionNode explicitVariableModes(Map<String, String> explicitVariableModes);

  SectionNode fillOverrideTable(Map<String, PaintOverride?> fillOverrideTable);

  SectionNode fillGeometry(List<Path> fillGeometry);

  SectionNode strokeGeometry(List<Path> strokeGeometry);

  SectionNode strokeCap(StrokeCap strokeCap);

  SectionNode strokeMiterAngle(num strokeMiterAngle);

  SectionNode fills(List<Paint> fills);

  SectionNode styles(Map<String, String> styles);

  SectionNode strokes(List<Paint> strokes);

  SectionNode strokeWeight(num strokeWeight);

  SectionNode strokeAlign(StrokeAlign? strokeAlign);

  SectionNode strokeJoin(StrokeJoin strokeJoin);

  SectionNode strokeDashes(List<num> strokeDashes);

  SectionNode children(List<SubCanvasNode> children);

  SectionNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  SectionNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  SectionNode preserveRatio(bool preserveRatio);

  SectionNode constraints(LayoutConstraint? constraints);

  SectionNode relativeTransform(Transform? relativeTransform);

  SectionNode size(Vector? size);

  SectionNode layoutAlign(LayoutAlign? layoutAlign);

  SectionNode layoutGrow(LayoutGrow layoutGrow);

  SectionNode layoutPositioning(LayoutPositioning layoutPositioning);

  SectionNode minWidth(num minWidth);

  SectionNode maxWidth(num maxWidth);

  SectionNode minHeight(num minHeight);

  SectionNode maxHeight(num maxHeight);

  SectionNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  SectionNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  SectionNode gridRowCount(num? gridRowCount);

  SectionNode gridColumnCount(num? gridColumnCount);

  SectionNode gridRowGap(num gridRowGap);

  SectionNode gridColumnGap(num gridColumnGap);

  SectionNode gridColumnsSizing(String? gridColumnsSizing);

  SectionNode gridRowsSizing(String? gridRowsSizing);

  SectionNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  SectionNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  SectionNode gridRowSpan(num gridRowSpan);

  SectionNode gridColumnSpan(num gridColumnSpan);

  SectionNode gridRowAnchorIndex(num gridRowAnchorIndex);

  SectionNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  SectionNode devStatus(DevStatus? devStatus);

  SectionNode sectionContentsHidden(bool sectionContentsHidden);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `SectionNode(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// SectionNode(...).copyWith(id: 12, name: "My name")
  /// ```
  SectionNode call({
    String id,
    String name,
...
/// Use as `instanceOfSectionNode.copyWith(...)` or call `instanceOfSectionNode.copyWith.fieldName(value)` for a single field.
class _$SectionNodeCWProxyImpl implements _$SectionNodeCWProxy {
  const _$SectionNodeCWProxyImpl(this._value);

  final SectionNode _value;

  @override
  SectionNode id(String id) => call(id: id);

  @override
  SectionNode name(String name) => call(name: name);

  @override
  SectionNode visible(bool visible) => call(visible: visible);

  @override
  SectionNode locked(bool locked) => call(locked: locked);
  ...
  @override
  SectionNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  SectionNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  SectionNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  ) => call(explicitVariableModes: explicitVariableModes);

  @override
  SectionNode fillOverrideTable(
    Map<String, PaintOverride?> fillOverrideTable,
  ...
  @override
  SectionNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  SectionNode fills(List<Paint> fills) => call(fills: fills);

  @override
  SectionNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  SectionNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  SectionNode strokeJoin(StrokeJoin strokeJoin) => call(strokeJoin: strokeJoin);
  ...
  @override
  SectionNode size(Vector? size) => call(size: size);
  ...
  @override
  SectionNode layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  SectionNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  SectionNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  SectionNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  SectionNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  SectionNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  SectionNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  SectionNode devStatus(DevStatus? devStatus) => call(devStatus: devStatus);
  ...
  SectionNode call({
    ...
    Object? sectionContentsHidden = const $CopyWithPlaceholder(),
  }) {
    return SectionNode(
      ...
      sectionContentsHidden:
          sectionContentsHidden == const $CopyWithPlaceholder() ||
              sectionContentsHidden == null
          ? _value.sectionContentsHidden
          // ignore: cast_nullable_to_non_nullable
          : sectionContentsHidden as bool,
    );
  }
}

extension $SectionNodeCopyWith on SectionNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfSectionNode.copyWith(...)` or `instanceOfSectionNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$SectionNodeCWProxy get copyWith => _$SectionNodeCWProxyImpl(this);
}
...
SectionNode _$SectionNodeFromJson(Map<String, dynamic> json) => SectionNode(
  ...
  sectionContentsHidden: json['sectionContentsHidden'] as bool,
);

Map<String, dynamic> _$SectionNodeToJson(
  ...
  'sectionContentsHidden': instance.sectionContentsHidden,
