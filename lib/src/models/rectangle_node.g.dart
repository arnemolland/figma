...
abstract class _$RectangleNodeCWProxy {
  RectangleNode id(String id);

  RectangleNode name(String name);

  RectangleNode visible(bool visible);

  RectangleNode locked(bool locked);

  RectangleNode scrollBehavior(ScrollBehavior scrollBehavior);

  RectangleNode rotation(num rotation);

  RectangleNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  RectangleNode pluginData(Object? pluginData);

  RectangleNode sharedPluginData(Object? sharedPluginData);

  RectangleNode boundVariables(LayerTraitVariables boundVariables);

  RectangleNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  RectangleNode blendMode(BlendMode blendMode);

  RectangleNode opacity(num opacity);

  RectangleNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  RectangleNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  RectangleNode preserveRatio(bool preserveRatio);

  RectangleNode constraints(LayoutConstraint? constraints);

  RectangleNode relativeTransform(Transform? relativeTransform);

  RectangleNode size(Vector? size);

  RectangleNode layoutAlign(LayoutAlign? layoutAlign);

  RectangleNode layoutGrow(LayoutGrow layoutGrow);

  RectangleNode layoutPositioning(LayoutPositioning layoutPositioning);

  RectangleNode minWidth(num minWidth);

  RectangleNode maxWidth(num maxWidth);

  RectangleNode minHeight(num minHeight);

  RectangleNode maxHeight(num maxHeight);

  RectangleNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  RectangleNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  RectangleNode gridRowCount(num? gridRowCount);

  RectangleNode gridColumnCount(num? gridColumnCount);

  RectangleNode gridRowGap(num gridRowGap);

  RectangleNode gridColumnGap(num gridColumnGap);

  RectangleNode gridColumnsSizing(String? gridColumnsSizing);

  RectangleNode gridRowsSizing(String? gridRowsSizing);

  RectangleNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  RectangleNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  RectangleNode gridRowSpan(num gridRowSpan);

  RectangleNode gridColumnSpan(num gridColumnSpan);

  RectangleNode gridRowAnchorIndex(num gridRowAnchorIndex);

  RectangleNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  RectangleNode fillOverrideTable(
    Map<String, PaintOverride?> fillOverrideTable,
  );

  RectangleNode fillGeometry(List<Path> fillGeometry);

  RectangleNode strokeGeometry(List<Path> strokeGeometry);

  RectangleNode strokeCap(StrokeCap strokeCap);

  RectangleNode strokeMiterAngle(num strokeMiterAngle);

  RectangleNode fills(List<Paint> fills);

  RectangleNode styles(Map<String, String> styles);

  RectangleNode strokes(List<Paint> strokes);

  RectangleNode strokeWeight(num strokeWeight);

  RectangleNode strokeAlign(StrokeAlign? strokeAlign);

  RectangleNode strokeJoin(StrokeJoin strokeJoin);

  RectangleNode strokeDashes(List<num> strokeDashes);

  RectangleNode exportSettings(List<ExportSetting> exportSettings);

  RectangleNode effects(List<Effect> effects);

  RectangleNode isMask(bool isMask);

  RectangleNode maskType(MaskType? maskType);

  RectangleNode transitionNodeId(String? transitionNodeId);

  RectangleNode transitionDuration(num? transitionDuration);

  RectangleNode transitionEasing(EasingType? transitionEasing);

  RectangleNode interactions(List<Interaction> interactions);

  RectangleNode cornerRadius(num cornerRadius);

  RectangleNode cornerSmoothing(num cornerSmoothing);

  RectangleNode rectangleCornerRadii(List<num> rectangleCornerRadii);

  RectangleNode individualStrokeWeights(StrokeWeights? individualStrokeWeights);
...
/// Use as `instanceOfRectangleNode.copyWith(...)` or call `instanceOfRectangleNode.copyWith.fieldName(value)` for a single field.
class _$RectangleNodeCWProxyImpl implements _$RectangleNodeCWProxy {
  const _$RectangleNodeCWProxyImpl(this._value);

  final RectangleNode _value;

  @override
  RectangleNode id(String id) => call(id: id);

  @override
  RectangleNode name(String name) => call(name: name);

  @override
  RectangleNode visible(bool visible) => call(visible: visible);

  @override
  RectangleNode locked(bool locked) => call(locked: locked);
  ...
  @override
  RectangleNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  RectangleNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  RectangleNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  RectangleNode opacity(num opacity) => call(opacity: opacity);
  ...
  @override
  RectangleNode size(Vector? size) => call(size: size);
  ...
  @override
  RectangleNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  RectangleNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  RectangleNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  RectangleNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  RectangleNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  RectangleNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  ) => call(gridChildVerticalAlign: gridChildVerticalAlign);

  @override
  RectangleNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  RectangleNode strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  RectangleNode fills(List<Paint> fills) => call(fills: fills);

  @override
  RectangleNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  RectangleNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  RectangleNode effects(List<Effect> effects) => call(effects: effects);

  @override
  RectangleNode isMask(bool isMask) => call(isMask: isMask);

  @override
  RectangleNode maskType(MaskType? maskType) => call(maskType: maskType);
  ...
  @override
  RectangleNode individualStrokeWeights(
    StrokeWeights? individualStrokeWeights,
...
extension $RectangleNodeCopyWith on RectangleNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfRectangleNode.copyWith(...)` or `instanceOfRectangleNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$RectangleNodeCWProxy get copyWith => _$RectangleNodeCWProxyImpl(this);
}
...
Map<String, dynamic> _$RectangleNodeToJson(
  RectangleNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
