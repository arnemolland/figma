...
part of 'text_path_type_style.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$TextPathTypeStyleCWProxy {
  TextPathTypeStyle fontFamily(String? fontFamily);

  TextPathTypeStyle fontPostScriptName(String? fontPostScriptName);

  TextPathTypeStyle fontStyle(String? fontStyle);

  TextPathTypeStyle italic(bool italic);

  TextPathTypeStyle fontWeight(num? fontWeight);

  TextPathTypeStyle fontSize(num? fontSize);

  TextPathTypeStyle textCase(TextCase? textCase);

  TextPathTypeStyle textAlignHorizontal(
    TextAlignHorizontal? textAlignHorizontal,
  );

  TextPathTypeStyle textAlignVertical(TextAlignVertical? textAlignVertical);

  TextPathTypeStyle letterSpacing(num? letterSpacing);

  TextPathTypeStyle fills(List<Paint> fills);

  TextPathTypeStyle hyperlink(Hyperlink? hyperlink);

  TextPathTypeStyle openTypeFlags(Map<String, num> openTypeFlags);

  TextPathTypeStyle semanticWeight(SemanticWeight? semanticWeight);

  TextPathTypeStyle semanticItalic(SemanticItalic? semanticItalic);

  TextPathTypeStyle isOverrideOverTextStyle(bool? isOverrideOverTextStyle);
  ...
  TextPathTypeStyle call({
    ...
    TextPathTypeStyleVariables boundVariables,
  });
}

/// Callable proxy for `copyWith` functionality.
/// Use as `instanceOfTextPathTypeStyle.copyWith(...)` or call `instanceOfTextPathTypeStyle.copyWith.fieldName(value)` for a single field.
class _$TextPathTypeStyleCWProxyImpl implements _$TextPathTypeStyleCWProxy {
  const _$TextPathTypeStyleCWProxyImpl(this._value);

  final TextPathTypeStyle _value;
  ...
  @override
  TextPathTypeStyle fontStyle(String? fontStyle) => call(fontStyle: fontStyle);

  @override
  TextPathTypeStyle italic(bool italic) => call(italic: italic);

  @override
  TextPathTypeStyle fontWeight(num? fontWeight) => call(fontWeight: fontWeight);

  @override
  TextPathTypeStyle fontSize(num? fontSize) => call(fontSize: fontSize);

  @override
  TextPathTypeStyle textCase(TextCase? textCase) => call(textCase: textCase);
  ...
  @override
  TextPathTypeStyle fills(List<Paint> fills) => call(fills: fills);
  ...
  TextPathTypeStyle call({
    ...
    return TextPathTypeStyle(
      ...
      boundVariables:
          ...
          // ignore: cast_nullable_to_non_nullable
          : boundVariables as TextPathTypeStyleVariables,
    );
  }
}

extension $TextPathTypeStyleCopyWith on TextPathTypeStyle {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfTextPathTypeStyle.copyWith(...)` or `instanceOfTextPathTypeStyle.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$TextPathTypeStyleCWProxy get copyWith =>
      _$TextPathTypeStyleCWProxyImpl(this);
}
...
TextPathTypeStyle _$TextPathTypeStyleFromJson(Map<String, dynamic> json) =>
    TextPathTypeStyle(
      ...
      boundVariables: json['boundVariables'] == null
          ...
          : TextPathTypeStyleVariables.fromJson(
              json['boundVariables'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$TextPathTypeStyleToJson(
  TextPathTypeStyle instance,
) => <String, dynamic>{
