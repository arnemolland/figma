...
import 'text_path_properties_trait.dart';
import 'text_path_type_style.dart';
import 'transform.dart';
import 'vector.dart';

part 'text_path_node.g.dart';

@JsonSerializable(explicitToJson: true)
@CopyWith()
@immutable
class TextPathNode extends SubCanvasNode
    with DefaultShapeTraits, TextPathPropertiesTrait {
  const TextPathNode({
    required this.id,
    required this.name,
    this.visible = true,
    ...
    required this.style,
    required this.characterStyleOverrides,
    this.layoutVersion,
    required this.styleOverrideTable,
  });

  factory TextPathNode.fromJson(Map<String, Object?> json) =>
      _$TextPathNodeFromJson(json);
  ...
  @override
  final TextPathTypeStyle style;

  @override
  final List<num> characterStyleOverrides;

  @JsonKey(includeIfNull: false)
  @override
  final num? layoutVersion;

  @override
  final Map<String, TextPathTypeStyle> styleOverrideTable;

  /// The type of this node, represented by the string literal "TEXT_PATH".
  @JsonKey(includeToJson: true)
  @override
  NodeType get type => NodeType.textPath;
  ...
  @override
  Map<String, Object?> toJson() => _$TextPathNodeToJson(this);
}
