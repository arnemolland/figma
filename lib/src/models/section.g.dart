...
abstract class _$SectionCWProxy {
  ...
  Section scrollBehavior(ScrollBehavior scrollBehavior);

  Section rotation(num rotation);

  Section componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  Section pluginData(Object? pluginData);

  Section sharedPluginData(Object? sharedPluginData);

  Section boundVariables(LayerTraitVariables boundVariables);

  Section explicitVariableModes(Map<String, String> explicitVariableModes);

  Section fillOverrideTable(Map<String, PaintOverride?> fillOverrideTable);

  Section fillGeometry(List<Path> fillGeometry);

  Section strokeGeometry(List<Path> strokeGeometry);

  Section strokeCap(StrokeCap strokeCap);

  Section strokeMiterAngle(num strokeMiterAngle);

  Section fills(List<Paint> fills);

  Section styles(Map<String, String> styles);

  Section strokes(List<Paint> strokes);

  Section strokeWeight(num strokeWeight);

  Section strokeAlign(StrokeAlign? strokeAlign);

  Section strokeJoin(StrokeJoin strokeJoin);

  Section strokeDashes(List<num> strokeDashes);

  Section children(List<SubCanvasNode> children);

  Section absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  Section absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  Section preserveRatio(bool preserveRatio);

  Section constraints(LayoutConstraint? constraints);

  Section relativeTransform(Transform? relativeTransform);

  Section size(Vector? size);

  Section layoutAlign(LayoutAlign? layoutAlign);

  Section layoutGrow(LayoutGrow layoutGrow);

  Section layoutPositioning(LayoutPositioning layoutPositioning);

  Section minWidth(num minWidth);

  Section maxWidth(num maxWidth);

  Section minHeight(num minHeight);

  Section maxHeight(num maxHeight);

  Section layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  Section layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  Section gridRowCount(num? gridRowCount);

  Section gridColumnCount(num? gridColumnCount);

  Section gridRowGap(num gridRowGap);

  Section gridColumnGap(num gridColumnGap);

  Section gridColumnsSizing(String? gridColumnsSizing);

  Section gridRowsSizing(String? gridRowsSizing);

  Section gridChildHorizontalAlign(GridChildAlign? gridChildHorizontalAlign);

  Section gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  Section gridRowSpan(num gridRowSpan);

  Section gridColumnSpan(num gridColumnSpan);

  Section gridRowAnchorIndex(num gridRowAnchorIndex);

  Section gridColumnAnchorIndex(num gridColumnAnchorIndex);

  Section devStatus(DevStatus? devStatus);
...
/// Use as `instanceOfSection.copyWith(...)` or call `instanceOfSection.copyWith.fieldName(value)` for a single field.
class _$SectionCWProxyImpl implements _$SectionCWProxy {
  ...
  @override
  Section id(String id) => call(id: id);

  @override
  Section name(String name) => call(name: name);

  @override
  Section visible(bool visible) => call(visible: visible);

  @override
  Section locked(bool locked) => call(locked: locked);
  ...
  @override
  Section rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  Section pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  Section strokeCap(StrokeCap strokeCap) => call(strokeCap: strokeCap);
  ...
  @override
  Section fills(List<Paint> fills) => call(fills: fills);

  @override
  Section styles(Map<String, String> styles) => call(styles: styles);

  @override
  Section strokes(List<Paint> strokes) => call(strokes: strokes);

  @override
  Section strokeWeight(num strokeWeight) => call(strokeWeight: strokeWeight);
  ...
  @override
  Section strokeJoin(StrokeJoin strokeJoin) => call(strokeJoin: strokeJoin);
  ...
  @override
  Section children(List<SubCanvasNode> children) => call(children: children);
  ...
  @override
  Section size(Vector? size) => call(size: size);
  ...
  @override
  Section layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  Section minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  Section maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  Section minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  Section maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  Section gridRowCount(num? gridRowCount) => call(gridRowCount: gridRowCount);
  ...
  @override
  Section gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  Section gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  Section devStatus(DevStatus? devStatus) => call(devStatus: devStatus);
...
extension $SectionCopyWith on Section {
  ...
  /// Example: `instanceOfSection.copyWith(...)` or `instanceOfSection.copyWith.fieldName(...)`.
