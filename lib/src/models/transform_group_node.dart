...
class TransformGroupNode extends SubCanvasNode with FrameTraits {
  ...
  factory TransformGroupNode.fromJson(Map<String, Object?> json) =>
      _$TransformGroupNodeFromJson(json);
  ...
  @override
  NodeType get type => NodeType.transformGroup;

  @override
  List<Object?> get props => <Object?>[...super.props];

  @override
  Map<String, Object?> toJson() => _$TransformGroupNodeToJson(this);
}
