...
part of 'regular_polygon_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$RegularPolygonNodeCWProxy {
  RegularPolygonNode id(String id);

  RegularPolygonNode name(String name);

  RegularPolygonNode visible(bool visible);

  RegularPolygonNode locked(bool locked);

  RegularPolygonNode scrollBehavior(ScrollBehavior scrollBehavior);

  RegularPolygonNode rotation(num rotation);

  RegularPolygonNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  RegularPolygonNode pluginData(Object? pluginData);

  RegularPolygonNode sharedPluginData(Object? sharedPluginData);

  RegularPolygonNode boundVariables(LayerTraitVariables boundVariables);

  RegularPolygonNode explicitVariableModes(
    Map<String, String> explicitVariableModes,
  );

  RegularPolygonNode blendMode(BlendMode blendMode);

  RegularPolygonNode opacity(num opacity);

  RegularPolygonNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  RegularPolygonNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  RegularPolygonNode preserveRatio(bool preserveRatio);

  RegularPolygonNode constraints(LayoutConstraint? constraints);

  RegularPolygonNode relativeTransform(Transform? relativeTransform);

  RegularPolygonNode size(Vector? size);

  RegularPolygonNode layoutAlign(LayoutAlign? layoutAlign);

  RegularPolygonNode layoutGrow(LayoutGrow layoutGrow);

  RegularPolygonNode layoutPositioning(LayoutPositioning layoutPositioning);

  RegularPolygonNode minWidth(num minWidth);

  RegularPolygonNode maxWidth(num maxWidth);

  RegularPolygonNode minHeight(num minHeight);

  RegularPolygonNode maxHeight(num maxHeight);

  RegularPolygonNode layoutSizingHorizontal(
    LayoutSizing? layoutSizingHorizontal,
  );

  RegularPolygonNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  RegularPolygonNode gridRowCount(num? gridRowCount);

  RegularPolygonNode gridColumnCount(num? gridColumnCount);

  RegularPolygonNode gridRowGap(num gridRowGap);

  RegularPolygonNode gridColumnGap(num gridColumnGap);

  RegularPolygonNode gridColumnsSizing(String? gridColumnsSizing);

  RegularPolygonNode gridRowsSizing(String? gridRowsSizing);

  RegularPolygonNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  );

  RegularPolygonNode gridChildVerticalAlign(
    GridChildAlign? gridChildVerticalAlign,
  );

  RegularPolygonNode gridRowSpan(num gridRowSpan);

  RegularPolygonNode gridColumnSpan(num gridColumnSpan);

  RegularPolygonNode gridRowAnchorIndex(num gridRowAnchorIndex);

  RegularPolygonNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  RegularPolygonNode fillOverrideTable(
    Map<String, PaintOverride?> fillOverrideTable,
  );

  RegularPolygonNode fillGeometry(List<Path> fillGeometry);

  RegularPolygonNode strokeGeometry(List<Path> strokeGeometry);

  RegularPolygonNode strokeCap(StrokeCap strokeCap);

  RegularPolygonNode strokeMiterAngle(num strokeMiterAngle);

  RegularPolygonNode fills(List<Paint> fills);

  RegularPolygonNode styles(Map<String, String> styles);

  RegularPolygonNode strokes(List<Paint> strokes);

  RegularPolygonNode strokeWeight(num strokeWeight);

  RegularPolygonNode strokeAlign(StrokeAlign? strokeAlign);

  RegularPolygonNode strokeJoin(StrokeJoin strokeJoin);

  RegularPolygonNode strokeDashes(List<num> strokeDashes);

  RegularPolygonNode exportSettings(List<ExportSetting> exportSettings);

  RegularPolygonNode effects(List<Effect> effects);

  RegularPolygonNode isMask(bool isMask);

  RegularPolygonNode maskType(MaskType? maskType);

  RegularPolygonNode transitionNodeId(String? transitionNodeId);

  RegularPolygonNode transitionDuration(num? transitionDuration);

  RegularPolygonNode transitionEasing(EasingType? transitionEasing);

  RegularPolygonNode interactions(List<Interaction> interactions);

  RegularPolygonNode cornerRadius(num cornerRadius);

  RegularPolygonNode cornerSmoothing(num cornerSmoothing);
...
/// Use as `instanceOfRegularPolygonNode.copyWith(...)` or call `instanceOfRegularPolygonNode.copyWith.fieldName(value)` for a single field.
class _$RegularPolygonNodeCWProxyImpl implements _$RegularPolygonNodeCWProxy {
  const _$RegularPolygonNodeCWProxyImpl(this._value);

  final RegularPolygonNode _value;

  @override
  RegularPolygonNode id(String id) => call(id: id);

  @override
  RegularPolygonNode name(String name) => call(name: name);

  @override
  RegularPolygonNode visible(bool visible) => call(visible: visible);

  @override
  RegularPolygonNode locked(bool locked) => call(locked: locked);
  ...
  @override
  RegularPolygonNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  RegularPolygonNode opacity(num opacity) => call(opacity: opacity);
  ...
  @override
  RegularPolygonNode size(Vector? size) => call(size: size);
  ...
  @override
  RegularPolygonNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  RegularPolygonNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  RegularPolygonNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  RegularPolygonNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  RegularPolygonNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  RegularPolygonNode fills(List<Paint> fills) => call(fills: fills);

  @override
  RegularPolygonNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  RegularPolygonNode strokes(List<Paint> strokes) => call(strokes: strokes);
  ...
  @override
  RegularPolygonNode effects(List<Effect> effects) => call(effects: effects);

  @override
  RegularPolygonNode isMask(bool isMask) => call(isMask: isMask);

  @override
  RegularPolygonNode maskType(MaskType? maskType) => call(maskType: maskType);
...
extension $RegularPolygonNodeCopyWith on RegularPolygonNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfRegularPolygonNode.copyWith(...)` or `instanceOfRegularPolygonNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$RegularPolygonNodeCWProxy get copyWith =>
      _$RegularPolygonNodeCWProxyImpl(this);
}
...
RegularPolygonNode _$RegularPolygonNodeFromJson(
...
Map<String, dynamic> _$RegularPolygonNodeToJson(
  RegularPolygonNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
