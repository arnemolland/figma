...
part of 'table_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$TableNodeCWProxy {
  TableNode id(String id);

  TableNode name(String name);

  TableNode visible(bool visible);

  TableNode locked(bool locked);

  TableNode scrollBehavior(ScrollBehavior scrollBehavior);

  TableNode rotation(num rotation);

  TableNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  TableNode pluginData(Object? pluginData);

  TableNode sharedPluginData(Object? sharedPluginData);

  TableNode boundVariables(LayerTraitVariables boundVariables);

  TableNode explicitVariableModes(Map<String, String> explicitVariableModes);

  TableNode children(List<SubCanvasNode> children);

  TableNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  TableNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  TableNode preserveRatio(bool preserveRatio);

  TableNode constraints(LayoutConstraint? constraints);

  TableNode relativeTransform(Transform? relativeTransform);

  TableNode size(Vector? size);

  TableNode layoutAlign(LayoutAlign? layoutAlign);

  TableNode layoutGrow(LayoutGrow layoutGrow);

  TableNode layoutPositioning(LayoutPositioning layoutPositioning);

  TableNode minWidth(num minWidth);

  TableNode maxWidth(num maxWidth);

  TableNode minHeight(num minHeight);

  TableNode maxHeight(num maxHeight);

  TableNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  TableNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  TableNode gridRowCount(num? gridRowCount);

  TableNode gridColumnCount(num? gridColumnCount);

  TableNode gridRowGap(num gridRowGap);

  TableNode gridColumnGap(num gridColumnGap);

  TableNode gridColumnsSizing(String? gridColumnsSizing);

  TableNode gridRowsSizing(String? gridRowsSizing);

  TableNode gridChildHorizontalAlign(GridChildAlign? gridChildHorizontalAlign);

  TableNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  TableNode gridRowSpan(num gridRowSpan);

  TableNode gridColumnSpan(num gridColumnSpan);

  TableNode gridRowAnchorIndex(num gridRowAnchorIndex);

  TableNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  TableNode strokes(List<Paint> strokes);

  TableNode strokeWeight(num strokeWeight);

  TableNode strokeAlign(StrokeAlign? strokeAlign);

  TableNode strokeJoin(StrokeJoin strokeJoin);

  TableNode strokeDashes(List<num> strokeDashes);

  TableNode effects(List<Effect> effects);

  TableNode blendMode(BlendMode blendMode);

  TableNode opacity(num opacity);
...
/// Use as `instanceOfTableNode.copyWith(...)` or call `instanceOfTableNode.copyWith.fieldName(value)` for a single field.
class _$TableNodeCWProxyImpl implements _$TableNodeCWProxy {
  const _$TableNodeCWProxyImpl(this._value);

  final TableNode _value;

  @override
  TableNode id(String id) => call(id: id);

  @override
  TableNode name(String name) => call(name: name);

  @override
  TableNode visible(bool visible) => call(visible: visible);

  @override
  TableNode locked(bool locked) => call(locked: locked);
  ...
  @override
  TableNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  TableNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  TableNode children(List<SubCanvasNode> children) => call(children: children);
  ...
  @override
  TableNode size(Vector? size) => call(size: size);
  ...
  @override
  TableNode layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  TableNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  TableNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  TableNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  TableNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  TableNode gridRowCount(num? gridRowCount) => call(gridRowCount: gridRowCount);
  ...
  @override
  TableNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  TableNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  ...
  @override
  TableNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  TableNode strokes(List<Paint> strokes) => call(strokes: strokes);

  @override
  TableNode strokeWeight(num strokeWeight) => call(strokeWeight: strokeWeight);
  ...
  @override
  TableNode strokeJoin(StrokeJoin strokeJoin) => call(strokeJoin: strokeJoin);
  ...
  @override
  TableNode effects(List<Effect> effects) => call(effects: effects);

  @override
  TableNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  TableNode opacity(num opacity) => call(opacity: opacity);
...
extension $TableNodeCopyWith on TableNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfTableNode.copyWith(...)` or `instanceOfTableNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$TableNodeCWProxy get copyWith => _$TableNodeCWProxyImpl(this);
}
