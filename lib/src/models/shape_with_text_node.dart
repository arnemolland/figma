...
@CopyWith()
@immutable
class ShapeWithTextNode extends SubCanvasNode
    with
        IsLayerTrait,
        HasLayoutTrait,
  ...
  factory ShapeWithTextNode.fromJson(Map<String, Object?> json) =>
      _$ShapeWithTextNodeFromJson(json);
  ...
  ///
  /// Most shape types have the same name as their tooltip but there are a few
  /// exceptions. ENG_DATABASE: Cylinder, ENG_QUEUE: Horizontal cylinder,
  /// ENG_FILE: File, ENG_FOLDER: Folder.
  ...
  @override
  NodeType get type => NodeType.shapeWithText;
  ...
  @override
  Map<String, Object?> toJson() => _$ShapeWithTextNodeToJson(this);
}
