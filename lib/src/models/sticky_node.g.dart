...
part of 'sticky_node.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$StickyNodeCWProxy {
  StickyNode id(String id);

  StickyNode name(String name);

  StickyNode visible(bool visible);

  StickyNode locked(bool locked);

  StickyNode scrollBehavior(ScrollBehavior scrollBehavior);

  StickyNode rotation(num rotation);

  StickyNode componentPropertyReferences(
    Map<String, String> componentPropertyReferences,
  );

  StickyNode pluginData(Object? pluginData);

  StickyNode sharedPluginData(Object? sharedPluginData);

  StickyNode boundVariables(LayerTraitVariables boundVariables);

  StickyNode explicitVariableModes(Map<String, String> explicitVariableModes);

  StickyNode absoluteBoundingBox(Rectangle? absoluteBoundingBox);

  StickyNode absoluteRenderBounds(Rectangle? absoluteRenderBounds);

  StickyNode preserveRatio(bool preserveRatio);

  StickyNode constraints(LayoutConstraint? constraints);

  StickyNode relativeTransform(Transform? relativeTransform);

  StickyNode size(Vector? size);

  StickyNode layoutAlign(LayoutAlign? layoutAlign);

  StickyNode layoutGrow(LayoutGrow layoutGrow);

  StickyNode layoutPositioning(LayoutPositioning layoutPositioning);

  StickyNode minWidth(num minWidth);

  StickyNode maxWidth(num maxWidth);

  StickyNode minHeight(num minHeight);

  StickyNode maxHeight(num maxHeight);

  StickyNode layoutSizingHorizontal(LayoutSizing? layoutSizingHorizontal);

  StickyNode layoutSizingVertical(LayoutSizing? layoutSizingVertical);

  StickyNode gridRowCount(num? gridRowCount);

  StickyNode gridColumnCount(num? gridColumnCount);

  StickyNode gridRowGap(num gridRowGap);

  StickyNode gridColumnGap(num gridColumnGap);

  StickyNode gridColumnsSizing(String? gridColumnsSizing);

  StickyNode gridRowsSizing(String? gridRowsSizing);

  StickyNode gridChildHorizontalAlign(GridChildAlign? gridChildHorizontalAlign);

  StickyNode gridChildVerticalAlign(GridChildAlign? gridChildVerticalAlign);

  StickyNode gridRowSpan(num gridRowSpan);

  StickyNode gridColumnSpan(num gridColumnSpan);

  StickyNode gridRowAnchorIndex(num gridRowAnchorIndex);

  StickyNode gridColumnAnchorIndex(num gridColumnAnchorIndex);

  StickyNode blendMode(BlendMode blendMode);

  StickyNode opacity(num opacity);

  StickyNode fills(List<Paint> fills);

  StickyNode styles(Map<String, String> styles);

  StickyNode isMask(bool isMask);

  StickyNode maskType(MaskType? maskType);

  StickyNode effects(List<Effect> effects);

  StickyNode exportSettings(List<ExportSetting> exportSettings);

  StickyNode characters(String characters);
...
/// Use as `instanceOfStickyNode.copyWith(...)` or call `instanceOfStickyNode.copyWith.fieldName(value)` for a single field.
class _$StickyNodeCWProxyImpl implements _$StickyNodeCWProxy {
  const _$StickyNodeCWProxyImpl(this._value);

  final StickyNode _value;

  @override
  StickyNode id(String id) => call(id: id);

  @override
  StickyNode name(String name) => call(name: name);

  @override
  StickyNode visible(bool visible) => call(visible: visible);

  @override
  StickyNode locked(bool locked) => call(locked: locked);
  ...
  @override
  StickyNode rotation(num rotation) => call(rotation: rotation);
  ...
  @override
  StickyNode pluginData(Object? pluginData) => call(pluginData: pluginData);
  ...
  @override
  StickyNode size(Vector? size) => call(size: size);
  ...
  @override
  StickyNode layoutGrow(LayoutGrow layoutGrow) => call(layoutGrow: layoutGrow);
  ...
  @override
  StickyNode minWidth(num minWidth) => call(minWidth: minWidth);

  @override
  StickyNode maxWidth(num maxWidth) => call(maxWidth: maxWidth);

  @override
  StickyNode minHeight(num minHeight) => call(minHeight: minHeight);

  @override
  StickyNode maxHeight(num maxHeight) => call(maxHeight: maxHeight);
  ...
  @override
  StickyNode gridRowGap(num gridRowGap) => call(gridRowGap: gridRowGap);
  ...
  @override
  StickyNode gridChildHorizontalAlign(
    GridChildAlign? gridChildHorizontalAlign,
  ...
  @override
  StickyNode gridRowSpan(num gridRowSpan) => call(gridRowSpan: gridRowSpan);
  ...
  @override
  StickyNode blendMode(BlendMode blendMode) => call(blendMode: blendMode);

  @override
  StickyNode opacity(num opacity) => call(opacity: opacity);

  @override
  StickyNode fills(List<Paint> fills) => call(fills: fills);

  @override
  StickyNode styles(Map<String, String> styles) => call(styles: styles);

  @override
  StickyNode isMask(bool isMask) => call(isMask: isMask);

  @override
  StickyNode maskType(MaskType? maskType) => call(maskType: maskType);

  @override
  StickyNode effects(List<Effect> effects) => call(effects: effects);
  ...
  @override
  StickyNode characters(String characters) => call(characters: characters);
  ...
  StickyNode call({
    ...
    Object? authorVisible = const $CopyWithPlaceholder(),
  }) {
    return StickyNode(
      ...
      authorVisible:
          authorVisible == const $CopyWithPlaceholder() || authorVisible == null
          ? _value.authorVisible
          // ignore: cast_nullable_to_non_nullable
          : authorVisible as bool,
    );
  }
}

extension $StickyNodeCopyWith on StickyNode {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfStickyNode.copyWith(...)` or `instanceOfStickyNode.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$StickyNodeCWProxy get copyWith => _$StickyNodeCWProxyImpl(this);
}
...
StickyNode _$StickyNodeFromJson(Map<String, dynamic> json) => StickyNode(
  ...
  authorVisible: json['authorVisible'] as bool? ?? false,
);

Map<String, dynamic> _$StickyNodeToJson(
  StickyNode instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  ...
  'authorVisible': instance.authorVisible,
